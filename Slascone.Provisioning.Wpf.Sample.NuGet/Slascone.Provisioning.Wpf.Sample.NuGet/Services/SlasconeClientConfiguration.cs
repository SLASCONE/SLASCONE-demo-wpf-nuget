...
namespace Slascone.Provisioning.Wpf.Sample.NuGet.Services
{
	public class SlasconeClientConfiguration
	{
		...
		public string ApiBaseUrl => "https://api.slascone.com"; 

		// Find your own Isv Id at : https://my.slascone.com/administration/apikeys
		public Guid IsvId => Guid.Parse("2af5fe02-6207-4214-946e-b00ac5309f53"); 
		...
		public Guid ProductId => Guid.Parse("b18657cc-1f7c-43fa-e3a4-08da6fa41ad3");
		...
		public int SignatureValidationMode => 2;
...
-----END PUBLIC KEY-----";
		...
		public string SignaturePublicKeyXml
			=> @"<RSAKeyValue>
